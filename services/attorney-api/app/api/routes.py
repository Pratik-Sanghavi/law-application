...
async def list_leads(request: Request,offset:int=0,limit:int=50,_=Depends(current_attorney)):
...
async def get_lead(lead_id:UUID,request:Request,_=Depends(current_attorney)):
